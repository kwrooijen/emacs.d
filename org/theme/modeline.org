...
(defun kwrooijen/modeline-org-clock ()
  (when (kwrooijen/weekday-p)
    (let ((face (if (org-clocking-p) 'kwrooijen/warning-fg-face 'kwrooijen/faded-fg-face)))
      (kwrooijen/modeline-r (format " [%s] [%s]" (kwrooijen/clocked-today) (kwrooijen/clocked-today-percentage)) face))))
#+END_SRC
