...
(set-face-attribute 'consult-highlight-match nil :inherit 'unspecified :foreground "#fffff" :weight 'bold)
(set-face-attribute 'consult-preview-match nil :inherit 'unspecified :foreground "#fffff" :weight 'bold)
#+END_SRC
...
** Config :config:
#+BEGIN_SRC emacs-lisp
(set-face-attribute 'orderless-match-face-0 nil :foreground "#ffffff" :weight 'bold)
(set-face-attribute 'orderless-match-face-1 nil :foreground "#ffffff" :weight 'bold)
(set-face-attribute 'orderless-match-face-2 nil :foreground "#ffffff" :weight 'bold)
(set-face-attribute 'orderless-match-face-3 nil :foreground "#ffffff" :weight 'bold)
#+END_SRC
