...
Set helm colors, some helm packages need to be required preemptively.
...
FIXME: This is disabled, if there is no need to enable this, remove it.
...
;; (remove-hook 'helm-after-initialize-hook #'kwrooijen/helm-hide-cursor)
#+END_SRC
