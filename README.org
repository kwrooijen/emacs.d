...
My personal Emacs configuration. This README is compiled using the [[https://github.com/kwrooijen/wisdom][Wisdom Emacs configuration framework]]. You can find all the separate org files in the org/ directory.
