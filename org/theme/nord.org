...
(defun kwrooijen/color-increase-brightness (hex &optional percent)
  "Increase brightness of HEX by PERCENT (default 10).
...
(defun kwrooijen/color-increase-saturation (hex &optional percent)
  "Increase saturation of HEX by PERCENT (default 10)."
  (let* ((p (/ (or percent 10) 100.0))
         (rgb (color-name-to-rgb hex))
...
(defun kwrooijen/define-face (face color &optional color2)
  ...
  (set-face-attribute (intern (format "kwrooijen/%s-bg-face" face)) nil :background color)
  (set-face-attribute (intern (format "kwrooijen/%s-fg-face" face)) nil :foreground color)
  (set-face-attribute (intern (format "kwrooijen/%s-fb-face" face)) nil
                      :foreground color
                      :background (or color2 color))
  )
...
(defun kwrooijen/set-theme (&rest opts)
  ...
  (kwrooijen/define-face 'warning (plist-get opts :warning))
  (kwrooijen/define-face 'success (plist-get opts :success))
...
(defgroup kwrooijen/colors nil
  "Color palette used by kwrooijen themes."
  :group 'faces)

(defcustom kwrooijen/color-strong "#FFFFFF"
  "Primary strong color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-foreground "#ECEFF4"
  "Default foreground color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-subtle "#434C5E"
  "Subtle secondary color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-faded "#616E88"
  "Faded or de-emphasized color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-salient "#81A1C1"
  "Salient accent color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-popout "#D08770"
  "Pop-out accent color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-error "#BF616A"
  "Error indication color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-warning "#FFC16D"
  "Warning indication color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-success "#A3BE8C"
  "Success indication color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-background "#222436"
  "Background color."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-darken "#1e2030"
  "Darker background variant."
  :type 'color
  :group 'kwrooijen/colors)

(defcustom kwrooijen/color-highlight "#2f334d"
  ...
  (defun kwrooijen/set-dark-theme ()
    (interactive)
    (kwrooijen/set-theme
     :background kwrooijen/color-background
     :foreground kwrooijen/color-foreground
     :strong kwrooijen/color-strong
     :subtle kwrooijen/color-subtle
     :faded kwrooijen/color-faded
     :darken kwrooijen/color-darken
     :highlight kwrooijen/color-highlight
     :salient kwrooijen/color-salient
     :popout kwrooijen/color-popout
     :error kwrooijen/color-error
     :warning kwrooijen/color-warning
     :success kwrooijen/color-success))
  ...
  (defun kwrooijen/set-light-theme ()
    ...
    (kwrooijen/set-theme
     ...
     :foreground "#101010"
     :strong     "#000000"
     :faded      (kwrooijen/color-increase-brightness "#101010" 60)
     :darken     (kwrooijen/color-increase-brightness "#fafafa" -2)
     :highlight  (kwrooijen/color-increase-brightness "#fafafa" 100)
     :subtle     (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-subtle -20) 30)
     :salient    (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-salient -20) 30)
     :popout     (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-popout -20) 30)
     :error      (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-error -20) 30)
     :warning    (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-warning -20) 30)
     :success    (kwrooijen/color-increase-saturation (kwrooijen/color-increase-brightness kwrooijen/color-success -20) 30)))
...
(kwrooijen/reset-inherit-face! 'fringe 'kwrooijen/background-bg-face)
...
(kwrooijen/reset-inherit-face! 'match 'bold)
...
(set-frame-parameter nil 'background-color (face-attribute 'kwrooijen/background-bg-face :background))
#+END_SRC
...
(defcustom kwrooijen/font-step-size
  20
  "Font size step size."
  :type 'integer
  :group 'kwrooijen)
...
;; diff-refine-added (currently dark)
;; magit-diff-added-highlight (currently light)
#+END_SRC
...
** Config :config:
#+BEGIN_SRC emacs-lisp
(kwrooijen/reset-inherit-face! 'ediff-even-diff-A 'default)
(kwrooijen/reset-inherit-face! 'ediff-even-diff-B 'default)
(kwrooijen/reset-inherit-face! 'ediff-odd-diff-A 'org-warning)
(kwrooijen/reset-inherit-face! 'ediff-odd-diff-B 'org-warning)
...
:END:
#+BEGIN_SRC emacs-lisp
(kwrooijen/reset-inherit-face! 'pulse-highlight-face 'kwrooijen/salient-bg-face)
(kwrooijen/reset-inherit-face! 'pulse-highlight-start-face 'kwrooijen/salient-bg-face)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(kwrooijen/reset-inherit-face! 'org-habit-clear-future-face 'kwrooijen/salient-fb-face)
(kwrooijen/reset-inherit-face! 'org-habit-alert-face 'kwrooijen/warning-fb-face)
(kwrooijen/reset-inherit-face! 'org-habit-overdue-future-face 'kwrooijen/error-fb-face)
#+END_SRC
